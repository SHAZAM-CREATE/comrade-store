    ...
    <footer class="site-footer">
      <div class="footer-inner">
        ...
        <nav class="footer-links" aria-label="Contact and social links">
          ...
          <a class="footer-link" href="${esc(SOCIAL_LINKS.facebook)}" target="_blank" rel="noopener noreferrer">
            <span class="footer-ic">📘</span> Facebook
          </a>
          <a class="footer-link" href="${esc(SOCIAL_LINKS.tiktok)}" target="_blank" rel="noopener noreferrer">
            <span class="footer-ic">🎵</span> TikTok
          </a>
        </nav>
      </div>
