  ...
  if (id) {
    ...
    if (product) {
      ...
      html = html
        ...
        .replace(/<meta property="og:type" content="product">/, `<meta property="og:title" content="${escapeHtml(title)}"><meta property="og:description" content="${escapeHtml(desc)}"><meta property="og:image" content="${escapeHtml(image)}"><meta property="og:type" content="product">`);
    }
  }
